       ...
       if(this.props.auth.isAuth){   
        ...
        return (
            <div>
                ...
                <h1>Criar conta</h1>
                {
                    this.props.error && <Segment color='red'>{this.props.auth.errorMessage}</Segment>
                }

                {
                    this.state.error === 'equal' && <Segment color='red'>Senhas devem ser iguais</Segment>
                }
                {
                    this.state.error === 'length' && <Segment color='red'>Senhas devem conter minimo de 6 caracteres</Segment>
                }
